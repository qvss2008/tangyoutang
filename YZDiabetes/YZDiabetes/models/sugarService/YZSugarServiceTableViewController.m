...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
            ...
            else
            {
                ...
                if (indexPath.row == 1) {
                    ...
                    [cell.imageView setImage:[UIImage imageNamed:@"service_shop.png"]];
                }
                if (indexPath.row == 2) {
                    cell.textLabel.text = @"反馈";
                    [cell.imageView setImage:[UIImage imageNamed:@"service_feedback.png"]];
                }
                if (indexPath.row == 3) {
                    cell.textLabel.text = @"同步";
                    [cell.imageView setImage:[UIImage imageNamed:@"service_synchronous.png"]];
                }
                if (indexPath.row == 4) {
                    cell.textLabel.text = @"设置";
                    [cell.imageView setImage:[UIImage imageNamed:@"service_settings.png"]];
                }
