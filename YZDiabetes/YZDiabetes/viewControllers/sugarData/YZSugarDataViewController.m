...
//    [self.dataLeftBtn setImage:[UIImage imageNamed:@"sugardata_leftSelect.png"] forState:UIControlStateNormal];
//    [self.dataLeftBtn setBackgroundImage:[UIImage imageNamed:@"sugardata_left.png"] forState:UIControlStateDisabled];
    [self.dataLeftBtn setBackgroundImage:[UIImage imageNamed:@"sugardata_leftSelect.png"] forState:UIControlStateNormal];
...
//    [self.dataRightBtn setImage:[UIImage imageNamed:@"sugardata_rightSelect.png"] forState:UIControlStateNormal];
    [self.dataRightBtn setBackgroundImage:[UIImage imageNamed:@"sugardata_rightSelect.png"] forState:UIControlStateNormal];
...
- (void)setHeadChartAction
{
    ...
    self.headChartView.backgroundColor = [UIColor redColor];
    [self.view addSubview:self.headChartView];
    
    
    self.headDataLab = [[UILabel alloc]initWithFrame:CGRectMake(0, 0, chartWight, 60)];
    ...
    self.headMorningLab = [[UILabel alloc]initWithFrame:CGRectMake(chartWight, 0, chartWight, 60)];
    ...
    self.headBreakfastLab = [[UILabel alloc]initWithFrame:CGRectMake(chartWight * 2, 0, chartWight * 2, 30)];
    ...
    self.headBreakfastBeforeLab = [[UILabel alloc]initWithFrame:CGRectMake(chartWight * 2, 30, chartWight, 30)];
    ...
    self.headBreakfastAfterLab = [[UILabel alloc]initWithFrame:CGRectMake(chartWight * 3, 30, chartWight, 30)];
    ...
    self.headLunchLab = [[UILabel alloc]initWithFrame:CGRectMake(chartWight * 4, 0, chartWight * 2, 30)];
    ...
    self.headLunchBeforeLab = [[UILabel alloc]initWithFrame:CGRectMake(chartWight * 4, 30, chartWight, 30)];
    self.headLunchBeforeLab.backgroundColor = BAR_SUJI_COLOR(255.0f, 160.0f, 122.0f, 1.0f);
    ...
    self.headLunchAfterLab = [[UILabel alloc]initWithFrame:CGRectMake(chartWight * 5, 30, chartWight, 30)];
    self.headLunchAfterLab.backgroundColor = BAR_SUJI_COLOR(255.0f, 160.0f, 122.0f, 1.0f);
    ...
    self.headDinnerLab = [[UILabel alloc]initWithFrame:CGRectMake(chartWight * 6, 0, chartWight * 2, 30)];
    ...
    self.headDinnerBeforeLab = [[UILabel alloc]initWithFrame:CGRectMake(chartWight * 6, 30, chartWight, 30)];
    self.headDinnerBeforeLab.backgroundColor = BAR_SUJI_COLOR(143.0f, 188.0f, 143.0f, 1.0f);
    ...
    self.headDinnerAfterLab = [[UILabel alloc]initWithFrame:CGRectMake(chartWight * 7, 30, chartWight, 30)];
    self.headDinnerAfterLab.backgroundColor = BAR_SUJI_COLOR(143.0f, 188.0f, 143.0f, 1.0f);
    ...
    self.headBeforeBadLab = [[UILabel alloc]initWithFrame:CGRectMake(chartWight * 8, 0, chartWight, 60)];
