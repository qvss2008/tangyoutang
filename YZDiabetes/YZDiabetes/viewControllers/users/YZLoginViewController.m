...
- (void)viewDidLoad {
    ...
    [self.tableView registerClass:[YZLoginLogoCell class] forCellReuseIdentifier:@"logoCell"];
...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.section == 0) {
        YZLoginLogoCell *logoCell = [tableView dequeueReusableCellWithIdentifier:@"logoCell" forIndexPath:indexPath];
        return logoCell;
    }
